...
const Resume = () => {
  ...
  return (
    <section id='resume' className='mx-5 shadow-2xl flex flex-col md:flex-row justify-center items-center h-auto md:h-screen bg-5 pb-10'>
        <div className='md:w-1/2 md:m-auto mt-10 flex flex-col justify-center items-center gap-3'> 
            ...
            <a href={API_KEY} 
                    ...
                    target="_blank"
                    className='bounce font-monospace inline-block text-center bg-primary text-amber-300 rounded-lg font-bold text-sm w-40 h-7 py-2 hover:bg-teal-500 ml-4'>Download / Review</a>
            </div>
            <div className='text-xs md:text-sm px-10 text-black font-monospace'>
                <p>👈 my resume here</p>
            </div>
        ...
        <div className='md:w-1/2 mt-14'>
            <img src={resume} className='object-cover h-[190px] w-[250px] md:h-[307px] md:w-[427px] m-auto rounded-3xl'/>
        </div>
