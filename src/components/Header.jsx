...
const Header = () => {
  ...
  return (
    <div className='m-5 '>
      <div className='flex justify-between px-5 bg-secondary py-6 h-20 rounded-xl shadow-2xl items-center'>
      <a href='#' className='font-bold text-white'><h1 className='sm:text-2xl'>My Portfolio</h1></a>
        ...
        {toggle && <nav className='block md:hidden  mobile-menu '>
            <ul onClick={()=>setToggle(!toggle)} className='flex flex-col text-white md:gap-3 gap-2 font-monospace'> 
                <li><a href='#home'>Home</a></li>
                <li><a href='#about'>About</a></li>
