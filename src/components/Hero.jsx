...
const Hero = () => {
  return (
    <section id='home' className='mx-5 rounded-2xl shadow-2xl flex flex-col-reverse md:flex-row px-10 py-32 bg-2 h-auto md:h-screen items-center '>
        <div className='md:w-2/3 ' >
            <div className='mx-10 flex flex-col justify-center items-center rounded-3xl shadow-xl p-5 bg-secondary gap-4 bounce '>
